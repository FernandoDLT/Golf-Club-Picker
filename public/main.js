...
function suggestClub(distance) {
    try {
        ...
        const clubs = [
            ...
            { name: "Driver, swing for the fences!", distance: clubDistances.driver }
        ];
...
// Save button works, but won't display hole. SWING BUTTON DOES NOT WORK!!
// START REOUND IS RETURNING AN ERROR, SWING DOES NOT WORK!!!
// BUT WE ARE GETTING THE CORRECTION SUGGEST CLUB IN THE RESULT <div>
...
// // Function to display the details for a specific hole
// function displayHole(hole, par, distance) {
//    const holeElement = document.querySelector('hole + number');
//    if (holeElement) {
//       holeElement.innerHTML = `
//         <h2>Hole #${hole.number}</h2>
//         <p>Par: ${hole.par}</p>
...
//     `;
//    } else {
//       console.error("Hole element with ID 'hole" + number + "' not found. ")
//    }
// }
...
// Club suggestion WORKS as intended!!
// Save button works. 
// START ROUND PRODUCES ERRORS FOR ALL HOLES, SWING BUTTON DOES NOT WORK!!!   
